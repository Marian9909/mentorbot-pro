...
st.set_page_config(
    page_title="MentorBot Pro - Versión Esencial",
    page_icon="📈",
    layout="wide"
)
...
st.write("Herramienta ágil para la validación rápida de tu operativa.")
...
with col1:
    ...
    st.info("Sube tus capturas de análisis para revisar la estructura y el patrón.")
    
    archivos_imagenes = st.file_uploader(
        "Sube tus gráficas (hasta 3 fotos)", 
        type=["png", "jpg", "jpeg"], 
...
with col2:
    ...
    st.info("💡 **Guía de Validación Visual:** Observa directamente tu gráfica en TradingView / Deriv y contrasta los puntos clave:")
    
    st.markdown("""
    * **Estructura y Patrón:** Verifica que el precio respete el impulso o canal trazado.
    * **Punto de Entrada:** Respeta el nivel exacto que marcaste en tu pantalla.
    * **Stop Loss (SL):** Asegúrate de colocarlo protegido tras el último alto o bajo estructural.
    * **Take Profit (TP):** Valida que tu objetivo de beneficio cumpla al menos con una relación de **1:2** respecto a tu riesgo.
    """)
...
st.markdown("<br><p style='text-align: center; color: gray;'>Academia de Trading Profesional - Versión Esencial y Directa</p>", unsafe_allow_html=True)
